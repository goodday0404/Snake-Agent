...
parser.add_argument('--numberOfSteps', type=int, required=False, default=70000,
...
def train(env, agent):
    ...
    for i in range(n_steps):
        ...
        while True:
            ...
            # start = time()
            agent.replay()
            # print("----- Replay time : %s ------" % (time() - start))
            agent.target_train()
